...
export default function Team() {
  ...
  return (
    <div className="text-accent-secondary px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          ...
          return (
            <div className="flex" key={person.linkedinUrl}>
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-md text-gray-800">{person.role}</p>
                <p className="text-md text-gray-800">{person.name}@gmail.com</p>
