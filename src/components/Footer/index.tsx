      ...
      <div className="container mx-auto flex flex-col justify-between space-y-8 py-10 lg:flex-row lg:space-y-0">
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-accent-primary">
              <svg
                ...
                viewBox="0 0 32 32"
                fill={iconColor}
                className="h-5 w-5 shrink-0 rounded-full text-gray-900"
              >
        ...
        <div className="grid grid-cols-2 gap-x-3 gap-y-8 text-sm sm:grid-cols-4 lg:w-2/3">
          <div className="space-y-3">
            <h3 className="font-bold uppercase tracking-wide text-accent-alternate">
              Product
            </h3>
          ...
          <div className="space-y-3">
            <div className="font-bold uppercase text-accent-alternate">
              Social media
            </div>
            <div className="flex justify-start space-x-3">
              <a
                ...
                href="#"
                title="Facebook"
                className="flex items-center p-1 text-accent-primary"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill={iconColor}
